...
public class ProgPrincipal extends javax.swing.JFrame
{
    ...
    Condition escuchar = cerrojo.newCondition();
    ...
    public ProgPrincipal()
    {
            ...
            try
            {
                ...
                hiloAccept hA=new hiloAccept(this);
                hA.start();
    ...
    public void aceptarClientes()
    {
        ...
        {         
            try {
                ...
                hiloCliente h=new hiloCliente(this,conexion);
                h.start();
            } catch (IOException ex) {
                Logger.getLogger(ProgPrincipal.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void pararExposicion()
    {
        System.out.println("hola");
        exposicion.parar();
    }
    public void reanudarExposicion()
    {
        exposicion.reanudar();
    }
